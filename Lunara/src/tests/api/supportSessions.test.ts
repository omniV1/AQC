...
describe('Support Session API', () => {
  ...
  describe('getSessions', () => {
    ...
    it('should fetch provider sessions', async () => {
      ...
      server.use(
        rest.get(`${baseUrl}/providers/${providerId}/sessions`, (req, res, ctx) => {
    ...
    it('should fetch client sessions', async () => {
      ...
      server.use(
        rest.get(`${baseUrl}/clients/${clientId}/sessions`, (req, res, ctx) => {
          return res(ctx.json(mockSessions));
        })
      );
  ...
  describe('updateSessionStatus', () => {
    ...
    it('should handle invalid status transitions', async () => {
      server.use(
        rest.patch(`${baseUrl}/sessions/${sessionId}/status`, (req, res, ctx) => {
          return res(
            ctx.status(400),
            ctx.json({
  ...
  describe('cancelSession', () => {
    ...
    it('should handle cancellation time limit', async () => {
      server.use(
        rest.post(`${baseUrl}/sessions/${sessionId}/cancel`, (req, res, ctx) => {
          return res(
            ctx.status(400),
            ctx.json({
