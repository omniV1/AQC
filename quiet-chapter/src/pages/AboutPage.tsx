    ...
    <div className="w-full bg-cream min-h-screen">
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <p className="text-brown/90 leading-relaxed">
              Welcome! The Quiet Chapter provides gentle, compassionate postpartum support for families in the West Valley. We believe the transition into parenthood deserves nurturing care, informed guidance, and a calm presence.
            </p>
        ...
        <footer className="mt-16 pt-8 border-t border-brown/10 text-center text-sm text-brown/70">
          <p>© 2023 The Quiet Chapter. All rights reserved.</p>
