...
export interface AuthenticatedRequest extends Request {
  user?: any; // Passport user can be any shape based on your user model
}
...
export type DocumentType = 'certification' | 'license' | 'insurance' | 'background_check' | 'medical' | 'identification' | 'other'; 