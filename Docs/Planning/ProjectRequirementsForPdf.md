...
![Home Page Wireframe](../img/Wireframes/home page2.png){#fig:home-page width=80%}
...
![About LUNARA Wireframe](../img/Wireframes/about lunara page2.png){#fig:about-lunara width=80%}
...
![About Doula Wireframe](../img/Wireframes/about doula page2.png){#fig:about-doula width=80%}
...
![Provider Page Wireframe](../img/Wireframes/provider page2.png){#fig:provider-page width=80%}

**Contact Page**
- **Purpose**: Contact information and inquiry form
- **Key Elements**: Contact form, office hours, location, social media links

![Contact Page Wireframe](../img/Wireframes/contact page2.png){#fig:contact-page width=80%}

**Login Page**
- **Purpose**: User authentication entry point
- **Key Elements**: Email/password fields, OAuth options, registration link, password reset

![Login Page Wireframe](../img/Wireframes/login page2.png){#fig:login-page width=80%}
